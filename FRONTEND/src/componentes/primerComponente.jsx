...
function PrimerComponente() {
  ...
  return (
    <div
      style={{ ...estiloComponente, textAlign: "center" }}
      className="contenedor-primercomponente"
    >
      <img
...
function SegundoArticulo() {
  ...
  return (
    <div
      style={{ ...estiloComponente, textAlign: "center" }}
      className="contenedor-segundoArticulo"
    >
      <img
        className="imagen-segundoArticulo imagen"
...
function TercerArticulo() {
  ...
  return (
    <div
      style={{ ...estiloComponente, textAlign: "flex-end" }}
      className="contenedor-tercerArticulo"
    >
      <img
        className="imagen-tercerArticulo imagen"
        src={require("../imagenes/sin-titulo-101-a37dc5d62f7c3d035a16584179086346-240-0.jpg")}
        alt="foto de una remera rosada"
      />

      <div className="Descripcion-del-articulo">
        <p className="nombre-del-articulo">Remera Rosada</p>
